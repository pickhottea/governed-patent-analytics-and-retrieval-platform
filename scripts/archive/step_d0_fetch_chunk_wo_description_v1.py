...
def main():
    ...
    ap.add_argument("--out_chunks", default="artifacts/chunks_wo_spec_v1.jsonl")
    ap.add_argument("--out_log", default="artifacts/spec_fetch_wo_v1.jsonl")
    ap.add_argument("--cache_dir", default="cache/ops_description/WO")
    ...
    # filter WO pubs
    wo_rows = [r for r in rows if str(r.get("selected_publication", "")).startswith("WO")]
    print(f"[info] WO rows = {len(wo_rows)}")
