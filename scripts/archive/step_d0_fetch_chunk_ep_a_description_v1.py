...
def main():
    ...
    ap.add_argument("--out_chunks", default="artifacts/chunks_ep_a_spec_v1.jsonl")
    ap.add_argument("--out_log", default="artifacts/spec_fetch_ep_a_v1.jsonl")
    ap.add_argument("--cache_dir", default="cache/ops_description/EP_A")
