"""
Purpose: Load ops_family_members.jsonl into bronze.ops_family_members_raw.
...
JSONL_PATH = PROJECT_ROOT / "data" / "raw" / "expansion" / "ops_family_members.jsonl"
...
TARGET_TABLE = "bronze.ops_family_members_raw"
SOURCE_FILE_NAME = "ops_family_members.jsonl"
BATCH_SIZE = 500
