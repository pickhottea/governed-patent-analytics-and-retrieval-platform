# gold.bridge_family_publication Contract v1
...
## 15. v1 Implementation Principle

Version 1 does not require full OPS family expansion to exist on day one.

Version 1 requires only that:
...
This makes v1 usable immediately, even before full expansion is complete.
...
> The bridge must preserve the relationship between the two.