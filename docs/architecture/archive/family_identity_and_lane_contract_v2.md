# Family Identity and Lane Contract v2
...
Its purpose is to prevent silent identity collapse when publication-level retrieval outputs, family-level reporting, and future OPS expansion are combined in the same warehouse.
...
- `policies/reference_key_and_traceability_policy_v1.md`
...
- future family-publication bridge alignment
...
This bridge table is the required alignment layer between:
...
5. only then decide how OPS expansion should affect landscape member metrics
